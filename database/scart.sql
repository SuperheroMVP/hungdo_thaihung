...
--
-- Host: localhost
-- Generation Time: Jun 16, 2020 at 11:30 AM
...
(64, 6, 0, 'Quản lý đại lý', 'fa-codepen', 'admin::provider', 0, NULL, NULL, '2020-06-11 03:17:25', '2020-06-11 03:17:25');
...
(5, 'Upload management', 'upload.full', 'ANY::sc_admin/uploads/*', '2020-06-11 03:10:15', NULL),
(6, 'Plugin manager', 'plugin.full', 'ANY::sc_admin/plugin/*', '2020-06-11 03:10:15', NULL),
(8, 'CMS manager', 'cms.full', 'ANY::sc_admin/page/*,ANY::sc_admin/banner/*,ANY::sc_admin/cms_category/*,ANY::sc_admin/cms_content/*,ANY::sc_admin/news/*', '2020-06-11 03:10:15', NULL),
...
(23, 'Provider Only', 'provider-only', 'GET::sc_admin/order,GET::sc_admin/order/detail/{id},POST::sc_admin/order/update,GET::sc_admin/order/product_info,GET::sc_admin/order/user_info,GET::sc_admin/order/export_detail,GET::sc_admin/provider,GET::sc_admin/provider/edit/{id},POST::sc_admin/provider/edit/{id},GET::sc_admin/provider/show/{id},POST::sc_admin/provider/show/{id}', '2020-06-16 03:27:35', '2020-06-16 04:40:38');
...
(7, 'Provider\'s User', 'provider-user', '2020-06-16 03:28:19', '2020-06-16 03:28:19');
...
INSERT INTO `sc_admin_user` (`id`, `username`, `password`, `name`, `email`, `provider_id`, `avatar`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'admin', '$2y$10$JcmAHe5eUZ2rS0jU1GWr/.xhwCnh2RU13qwjTPcqfmtZXjZxcryPO', 'Administrator', 'your-email@your-domain.com', NULL, '/admin/avatar/user.jpg', NULL, '2020-06-11 03:10:15', NULL),
(2, 'dayne_rohan52', '$2y$10$ls3MsDQHg6bPwvWDz7RLiu38sDF.iDqzZEirx5NyaMHsYtlwWicqG', 'Michelle Mohr Jr.', 'tempmail86529@emailna.co', 2, 'http://localhost/s-cart/public/data/avatar/user.jpg', NULL, '2020-06-16 03:28:48', '2020-06-16 07:59:24');
...
(1, 1, 5000, 2000, 0, 1, 1, 1, 0, 7000, 'USD', 1.00, 0, 7000, 'Naruto', 'Kun', 'ADDRESS 1', 'ADDRESS 2', 'VN', NULL, NULL, '667151172', 'test@test.com', 'ok', NULL, 'Cash', 'ShippingStandard', NULL, NULL, NULL, '2020-06-11 03:10:15', '2020-06-13 02:59:02'),
...
(3, 0, 3000, 20, 0, 1, 1, 1, 300, 3320, 'VND', 1.00, 0, 3320, 'Karelle', 'Murray', '90143 Halvorson Drive', '8660 Jermey Port', 'AE', '', '', '0959688635', 'tempmail42430@emailna.co', 'Cruickshank Inc', 2, 'Cash', 'ShippingStandard', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36 OPR/68.0.3618.125', '::1', NULL, '2020-06-16 07:43:55', '2020-06-16 07:43:55');
...
(1, 'ABCZZ', NULL, NULL, NULL, NULL, NULL, '/data/product/img-1.jpg', 1, '1', NULL, 15000, 10000, 99, 1, 0, NULL, 0, NULL, 0, 0, 0, 0, 0, 'auto', 1, 0, 3, 'demo-alias-name-product-1', '2020-06-13 10:43:10', '2020-07-11', NULL, '2020-06-13 03:43:10'),
