...
class Cart
{
     ...
     */
    public function add($id, $name = null, $qty = null, $price = null, array $options = [], $tax = 0, $donvi = 1, $giatri =1)
    {
        $cartItem = $this->createCartItem($id, $name, $qty, $price, $options, $tax, $donvi, $giatri);
     ...
     * @return \App\Library\ShoppingCart\CartItem
     */
    private function createCartItem($id, $name, $qty, $price, array $options, $tax = 0, $donvi = 1, $giatri = 1)
    {
        if (is_array($id)) {
            $id['donvi'] = $id['donvi'] ?? 1;
            $id['giatri'] = $id['giatri'] ?? 1;
            $cartItem = CartItem::fromArray($id);
            $cartItem->setQuantity($id['qty']);
        } else {
            $cartItem = CartItem::fromAttributes($id, $name, $price, $options, $tax, $donvi, $giatri);
