...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (Admin::user()->provider_id){
            $dataCountries = (new ShopOrder)->getCountryInYearProvider();
        }
        else{
        ...
        //Order in 30 days
        if (Admin::user()->provider_id){
            $totalsInMonth = (new ShopOrder)->getSumOrderTotalInMonthProvider()->keyBy('md')->toArray();
        }
        else{
        ...
        //Order in 12 months
        if (Admin::user()->provider_id){
            $totalsMonth = (new ShopOrder)->getSumOrderTotalInYearProvider()
