...
class ShopCategory extends Model
{
    ...
    public function productDescription()
    {
        ...
        return $this->belongsToMany(ShopProduct::class, SC_DB_PREFIX . 'shop_product_category', 'category_id', 'product_id')->
        with('descriptions')->
        leftJoin($tableProductDescription, $tableProductDescription . '.product_id', $tableProduct . '.id')->
        where($tableProductDescription . '.lang', sc_get_locale());
    }
    ...
    */
    ...
    public function count_product($id){
        return DB::table('sc_shop_product_category')->where('category_id', $id)->count();
    }
}
