...
class ShopDebtProvider extends Model
{
    use ModelTrait;

    public $timestamps = true;
    public $table = 'shop_debt_provider';
    protected $guarded = [];
...
//Scort
    ...
    public function debt_provider_description(){
        return $this->hasMany('App\Models\ShopDebtProviderDiscription', 'debt_provider_id', 'id');
    }
}
