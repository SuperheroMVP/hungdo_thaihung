...
class ShopProduct extends Model
{
    ...
    public function descriptionsForProvider()
    {
        return $this->hasMany(ShopProductDescription::class, 'product_id', 'id')->where('lang', 'vi');
    }
    public function descriptions_relation()
    {
        return $this->hasOne(ShopProductDescription::class, 'product_id', 'id')->where('lang', 'vi');
    }
    ...
    public function tags(){
        return $this->hasMany(ShopTag::class, 'sc_product_tag', 'product_id','tag_id');
    }
    /*
    *Get final price
    */
...
//        }
    ...
    */
     ...
     * @return [type] [description]
     */
    public function getGroupDetailUrl()
    {
        return route('product.group_detail', ['alias' => $this->alias]);
    }
    ...
    public function renderAttributeDetailsQty()
    {
        return  view('templates.'.sc_store('template').'.common.render_attribute_qty', 
        [
            'details' => $this->attributes()->get()->groupBy('attribute_group_id'),
            'groups' => ShopAttributeGroup::getList(),
        ]);
...
//            $this->sc_relation = $relation;
//        } else {
//            $this->sc_relation = array((int)$relation);
//        }
//        return $this;
//    }
...
//    public function getProductToRelation($arrProduct) {
//        $this->setStatus(1);
//        $this->setRelation($arrProduct);
//        return $this;
//    }
