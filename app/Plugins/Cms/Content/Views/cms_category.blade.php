            ...
            <div class="col-md-8">
                <main class="l-main-content">
                    <div class="posts-group-2">
                        @if($entries->count()>0)
                            @foreach($entries as $newsDetails)
                                <section class="b-post b-post-full clearfix">
                                    <div class="entry-main">
                                        ...
                                        <div class="entry-header">
                                            <h2 class="entry-title"><a href="blog-post.html">{{$newsDetails->title}}</a></h2>
                                        </div>
...
{{--                    </div>--}}
                    ...
                    <section class="widget section-sidebar">
                        <h3 class="widget-title ui-title-inner">Danh Mục</h3>
                        @php
                        ...
                        <div class="widget-content">
                            <ul class="widget-list list list-mark-5">
                                @if($cmsCategories->count()>0)
                                    @foreach ($cmsCategories as $cmsCategory)
                                      <li class="widget-list__item"><a class="widget-list__link" href="{{ $cmsCategory->getUrl() }}">{{ sc_language_render($cmsCategory->title) }}</a></li>
                                    @endforeach
                                @endif
                            </ul>
                        </div>
