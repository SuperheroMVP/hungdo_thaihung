                                    ...
                                    <div class="d-flex align-items-center pr-2 mb-6">
                                        ...
                                        <div class="symbol symbol-50">
															<span class="symbol-label bg-light-light">
																<img src="{{ asset('admin/metronic/assets/media/svg/misc/006-plurk.svg') }}" class="h-50 align-self-center" alt="" />
															</span>
                                        </div>
                                    </div>
                                    <!--end::Info-->
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                        <div class="symbol-label">
                                            <img src="{{ asset('admin/metronic/assets/media/svg/avatars/001-boy.svg') }}" class="h-75 align-self-end" alt="" />
                                        </div>
                                    </a>
                                    <!--end::Pic-->
                                    <!--begin::Pic-->
                                    <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                        <div class="symbol-label">
                                            <img src="{{ asset('admin/metronic/assets/media/svg/avatars/028-girl-16.svg') }}" class="h-75 align-self-end" alt="" />
                                        </div>
                                    </a>
                                    <!--end::Pic-->
                                    <!--begin::Pic-->
                                    <a href="#" class="symbol symbol-45 symbol-light">
                                        <div class="symbol-label">
                                            <img src="{{ asset('admin/metronic/assets/media/svg/avatars/024-boy-9.svg') }}" class="h-75 align-self-end" alt="" />
                                        </div>
                                    </a>
                                    <!--end::Pic-->
                                </div>
