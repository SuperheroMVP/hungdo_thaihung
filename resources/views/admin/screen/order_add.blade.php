                        ...
                        @if (sc_config('customer_address2'))    
                            <div class="form-group   {{ $errors->has('address2') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group   {{ $errors->has('address3') ? ' has-error' : '' }}">
                                    <label for="address3" class="col-sm-2 col-form-label">Địa chỉ</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control currency select2" style="width: 100%;" name="currency" >
                                      ...
                                      @foreach ($currencies as $k => $v)
                                            <option value="{{ $k }}" {{ (old('currency') ==$k) ? 'selected':'' }} {{$k == 'VND' ? 'selected':''}}>{{ $v}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group   {{ $errors->has('exchange_rate') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input style="width: 150px" type="text" id="exchange_rate" name="exchange_rate" value="{!! old('exchange_rate') ?? 1 !!}" class="form-control exchange_rate" placeholder="Input Exchange rate" />
                                    </div>
    ...
    if(id){
       $.ajax({
            ...
            success: function(result){
                ...
                $('[name="address3"]').val((returnedData.address || '' )+", "+(returnedData.address3 || ''));
