                        ...
                        <div class="fields-group">
                            ...
                            <div class="form-group row {{ $errors->has('reg_address2') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group row {{ $errors->has('reg_address') ? ' has-error' : '' }}">
                                        <label for="reg_address"
                                               class="col-sm-2 col-form-label text-md-right">{{ trans('account.address') }}</label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                                <input id="reg_address" type="text" class="form-control" name="reg_address" required
                                                       value="{{ (old('reg_address', $customer['address'] ?? ''))}}">
                                            </div>
