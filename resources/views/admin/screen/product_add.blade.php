                ...
                <div class="box-body" id="main-add">
                    <div class="fields-group">
                        ...
                        <div
                            ...
                            <div
                                class="form-group   kind kind0  {{ $errors->has('descriptions.'.$code.'.general_details') ? ' has-error' : '' }}">
                            ...
                            <textarea id="{{ $code }}__content" class="editor"
                                    ...
                                    {!! old('descriptions.'.$code.'.general_details') !!}
                                </textarea>
                        ...
                        <div class="form-group  kind kind0 kind1 {{ $errors->has('tags') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control input-sm category select2" multiple="multiple"
                                    ...
                                    @foreach ($tags as $k => $v)
                                        <option value="{{ $v->id }}"
                                                {{ (count($listTags) && in_array($k, $listTags))?'selected':'' }}>{{ $v->title }}
                                        </option>
                                    @endforeach
                                </select>
                                @if ($errors->has('tags'))
...
@if (sc_config('product_cost'))
                        ...
                        <div class="form-group  kind kind0 kind1  {{ $errors->has('cost') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="text" style="width: 100px;" id="cost" name="cost"
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="unit" name="unit"
                                           value="{!! old('unit')??0 !!}" class="form-control input-sm cost"
                                           placeholder="" />
                                </div>
                                @if ($errors->has('unit'))
                                    <span class="help-block">
...
@endif
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-8">
                                @if (old())
                                    <input class="input" type="checkbox" name="outstanding" {{ ((old('outstanding') ==='on')?'checked':'')}}>
                                @else
