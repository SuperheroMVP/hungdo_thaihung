          ...
          <div class="row" id="order-body">
            <div class="col-sm-6">
                 <table class="table table-bordered">
                    ...
                    <tr>
                      <td class="td-title">Địa chỉ:</td><td><a href="#" class="updateInfoRequired" data-name="address3" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.address3') }}" >{!! $order->address3 !!}</a></td>
                    </tr>
                 ...
                 <table class="table table-bordered">
                    <tr>
                      <td class="td-title">
                          Nhà bán hàng:</td>
                        <td>
                            @if($provider)<a href="{{ route('agency.show', ['alias' => $provider->alias]) }}">{{ $provider->name }}</a>@else Không tồn tại @endif
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="product_qty">Đơn vị tính</th>
                ...
                <tbody>
                    @foreach ($order->details as $item)
                          <tr>
                            ...
                            <td class="product_total item_id_{{ $item->id }}">{{ $item->get_dvt($item->product_id) }}</td>
      ...
      <div class="row">
        {{-- Total --}}
                ...
                <table   class="table table-bordered">
                  @foreach ($dataTotal as $element)
                    ...
                    @if ($element['code'] =='shipping')
                      <tr><td>Phí vận chuyển:</td><td style="text-align:right"><a href="#" class="updatePrice data-{{ $element['code'] }}"  data-name="{{ $element['code'] }}" data-type="text" data-pk="{{ $element['id'] }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.shipping_price') }}">{{$element['value'] }}</a></td></tr>
                    @endif
                    @if ($element['code'] =='discount')
                      <tr><td>Giảm giá (-):</td><td style="text-align:right"><a href="#" class="updatePrice data-{{ $element['code'] }}" data-name="{{ $element['code'] }}" data-type="text" data-pk="{{ $element['id'] }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.discount') }}">{{$element['value'] }}</a></td></tr>
                    @endif
                    ...
                    @if ($element['code'] =='received')
                      <tr><td>Đã thanh toán(-):</td><td style="text-align:right"><a href="#" class="updatePrice data-{{ $element['code'] }}" data-name="{{ $element['code'] }}" data-type="text" data-pk="{{ $element['id'] }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.received') }}">{{$element['value'] }}</a></td></tr>
                    @endif
          ...
          <div class="col-md-12 float-right not-print">
              <form action="{{route('admin_order.change_status')}}" method="post" style="float: right; padding: 10px;">
                  @csrf
...
@php
  ...
  $htmlSelectProduct .='
              ...
              <td><input type="text" disabled class="add_unit form-control"></td>
