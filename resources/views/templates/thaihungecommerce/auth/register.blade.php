...
<form action="{{route('postRegister')}}" method="post" class="box">
    ...
    <div class="form_content {{ (old('check_red'))?'in':'' }}" id="collapseExample">
        ...
        <div class="form-group{{ $errors->has('reg_first_name') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_first_name'))?"input-error":"" }}"
        ...
        <div class="form-group{{ $errors->has('reg_last_name') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_last_name'))?"input-error":"" }}"
        ...
        <div class="form-group{{ $errors->has('reg_email') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_email'))?"input-error":"" }}"
        ...
        <div class="form-group{{ $errors->has('reg_phone') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_phone'))?"input-error":"" }}"
        ...
        <div class="form-group{{ $errors->has('reg_postcode') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_postcode'))?"input-error":"" }}"
        ...
        <div class="form-group{{ $errors->has('reg_address1') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_address1'))?"input-error":"" }}"
        ...
        <div class="form-group{{ $errors->has('reg_address2') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_address2'))?"input-error":"" }}"
        ...
        <div class="form-group{{ $errors->has('reg_company') ? ' has-error' : '' }}">
            <input type="text"
                class="is_required validate account_input form-control w-100 {{ ($errors->has('reg_company'))?"input-error":"" }}"
        ...
        <div class="submit">
            <button type="submit" name="SubmitCreate" class="btn btn-default btn-success">{{ trans('account.signup') }}</button>
        </div>
    </div>
