                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="control-label"><i class="fa fa-truck"
                                                             aria-hidden="true"></i> {{ trans('cart.shipping_address') }}
                                    :<br></h3>
                                <table class="table box table-bordered" id="showTotal">
                                    ...
                                    <tr>
                                        <th>{{ trans('cart.address') }}:
                                        </td>
                                        <td>{{ $shippingAddress['address3'].', '.$shippingAddress['address2'].', '.$shippingAddress['address1'].','.$shippingAddress['country'] }}</td>
                                    </tr>
                                    @if (sc_config('customer_postcode'))
                                        <tr>
                                            <th>{{ trans('cart.postcode') }}:
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $dataProvider->name }}
                                            <br> {{ $dataProvider->address.', '.$dataProvider->ward.', '.$dataProvider->district.', '.$dataProvider->province }}
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <h3 class="control-label"><i
                                                                class="fa fa-credit-card-alt"></i> {{ trans('cart.payment_method') }}
                                                        :<br></h3>
                                                </div>
                                                <div class="form-group">
                                                    <div>
