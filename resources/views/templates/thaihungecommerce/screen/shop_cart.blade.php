                                ...
                                <tr class="row_cart">
                                    ...
                                    <td>
                                        <input style="width: 70px;" type="number" data-id="{{ $item->id }}"
                                               ...
                                               class="item-qty" name="qty-{{$item->id}}" value="{{$item->qty}}"><span
                            ...
                            <tr style="background: #eaebec">
                                <td colspan="7">
                                    ...
                                    <div class="pull-right">
                                        <button class="btn" type="button" style="cursor: pointer;padding:10px 30px"
                                    ...
                                    @if (sc_config('customer_country'))
                                        <tr>
                                            <td colspan="2"
                                                ...
                                                <label for="country" class="control-label"><i class="fa fa-dribbble"
                                                                                              aria-hidden="true"></i> {{ trans('cart.country') }}
                                                    :</label>
                                                @php
                                    ...
                                    <tr>
                                        @if (sc_config('customer_address2'))
                                            ...
                                            <td class="form-group{{ $errors->has('address2') ? ' has-error' : '' }}">
                                                ...
                                                <select class="select2" style="width: 100%" id="select_districts"
                                                        name="address2">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <label for="address3" class="control-label"><i
                                                ...
                                                :</label>
                                            <input type="text" name="address3" required="required">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <label class="control-label"><i
                                                        class="fa fa-calendar-o"></i> {{ trans('cart.note') }}:</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="pickProvider" class="control-label"><i class="fa fa-tv"
                                                                                           aria-hidden="true"></i> Chọn
                                            nhà bán hàng</label>
                                        <div class="list-group">
                                            ...
                                            @else
                                                ...
                                                @foreach($providerList as $key => $provider)
                                                    ...
                                                    <label class="list-group-item" for="provider{{ $provider->id }}">
                                ...
                                <div class="row" style="padding-bottom: 20px;">
                                    <div class="col-md-12 text-center">
                                        <div class="pull-right">
                                            <button class="btn btn-success" id="submit-order" type="button"
...
@push('scripts')
    <script type="text/javascript">
        ...
        $.getJSON('{{asset('json/local.json')}}', function (data) {
            $.each(data, function (index, item) {
                let opt;
                opt = $('<option value="' + item.name + '">' + item.name + '</option>');
                $('#select_provincial').append(opt);
            })
            $('#select_provincial').change(function () {
                $('#select_districts').empty();
                let provincial = $(this).find(':selected').text();
                $.each(data, function (index, item) {
                    if (item.name == provincial) {
                        $.each(item.districts, function (index1, item1) {
                            let opt1;
                            opt1 = $('<option value="' + item1.name + '">' + item1.name + '</option>');
                            $('#select_districts').append(opt1).trigger('change');
                        })
                    }
                })
            });
        ...
        $.getJSON("json/local.json", function (json) {
