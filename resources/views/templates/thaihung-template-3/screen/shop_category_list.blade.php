                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <a class="js-zoom-images" href="{{$product->getThumb()}}">
                                                <img class="img-responsive" src="{{ asset($product->getThumb()) }}" alt="{{$product->name}}" />
                                            </a>
                                        </div>
                                        <div class="col-md-8 col-sm-12">
                                            <div class="b-goods-1__header"><a class="b-goods-1__choose hidden-th" href="listing-1.html"><i class="icon fa fa-heart-o"></i></a>
                                                <h2 class="b-goods-1__name"><a href="{{$product->getGroupDetailUrl()}}">{{$product->name}}</a></h2>
                                            </div>
                                            <div class="b-goods-1__info">{{$product->description}}<span class="b-goods-1__info-more collapse" id="info-2">{{$product->description}}</span>
                                                <span class="b-goods-1__info-link" data-toggle="collapse" data-target="#info-2"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                @if($categoriesTop->count())
                                    @foreach($categoriesTop as $category)
                                        @if(!empty($categories[$category->id]))
                                            <li><a href="{{$category->getUrl()}}" data-toggle="" aria-expanded="" class="dropdown-toggle2">{{$category->title}}</a>
                                        ...
                                        @else
                                            <li><a href="{{$category->getUrl()}}" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle2">{{$category->title}}</a>
                                        @endif
                                    @endforeach
                                @endif
                            </ul>
